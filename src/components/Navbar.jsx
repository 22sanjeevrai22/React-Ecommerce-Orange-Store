...
const Navbar = () => {
  ...
  const navLinkClass = ({ isActive }) =>
    isActive ? "text-green-600 font-bold" : "text-gray-400 hover:text-gray-500";

  return (
    <>
      <div className="bg-slate-50 shadow-md">
        <nav className="max-w-[1200px] m-auto relative px-4 py-4 flex justify-between items-center">
