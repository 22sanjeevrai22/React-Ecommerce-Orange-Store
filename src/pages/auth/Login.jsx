    ...
    <div className="">
      <div className="max-w-[1200px] mx-auto bg-gray-200">
        <div className="flex flex-col lg:flex-row justify-between">
          <div
            className="sm:w-[90%] md:w-[70%] lg:w-[60%] h-[85vh] bg-gradient-to-r from-orange-400 to-orange-600 text-white text-center p-6 content-center"
            style={{ clipPath: "circle(100% at 0 50%)" }}
          >
            <div className="text-left w-4/5">
              <h1 className="text-5xl lg:text-6xl font-bold uppercase">
                Welcome to Orange Store
                <span className="text-red-600 leading-[1.5rem] text-9xl">
                  .
                </span>
              </h1>
